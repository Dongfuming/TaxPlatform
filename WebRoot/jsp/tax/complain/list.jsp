...
<head>
    ...
    <script type="text/javascript">
  	var list_url = "${basePath}/tax/complain/listComplain.action";
  	//搜索
  	function doSearch(){
  		//重置页号
  		$("#pageNo").val(1);
  	...
  	function doDeal(compId){
  		document.forms[0].action = "${basePath}/tax/complain/toDealComplainPage.action?complain.compId=" + compId;
  		document.forms[0].submit();
  	}
  	// 统计
  	function doAnnualStatistic() {
  		document.forms[0].action = "${basePath}/tax/complain/toYearStatisticChartPage.action";
  		document.forms[0].submit();
  	}
    </script>
</head>
