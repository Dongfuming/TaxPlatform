			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="right"><a><b></b><font color="white">欢迎您，${sessionScope.LOGIN_USER.name }</font></a></td> 
                        <td align="center"><img src="${basePath}/images/nsfw/help.png" width="14"height="16" /></td>
						<td align="left" style=""><a href="javascript:void(0)">帮助</a></td>
						<td width="17" align="center"><img src="${basePath }/images/nsfw/exit.png"width="14" height="14"/></td>
						<td align="left" valign="middle"><a href="${basePath }/system/login/logout.action" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
