        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="white">欢迎您，<s:property value="#session.LOGIN_USER.name"/>&nbsp;</font></a>
                    </td>
                    <td align="center"><img src="${basePath}/images/home/help.png" width="14" height="16"  /></td>
                    ...
                    <td align="left" valign="middle" ><a href="${basePath }/system/login/logout.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px;">
                	<s:a action="toAddComplainPage" namespace="/system/home" target="_blank">我要投诉</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
